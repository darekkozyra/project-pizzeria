...
class Booking{
  constructor(element){
    ...
    thisBooking.chosedTableId=null;

    thisBooking.render(element);
    thisBooking.initWidgets();
    thisBooking.getData();
    thisBooking.chosedTable();
    ...
    tables.forEach(function(table){
      table.addEventListener('click', function(event){
        ...
        if(!table.classList.contains(classNames.booking.tableBooked)){
          table.classList.add(classNames.booking.tableChosed);
          thisBooking.chosedTableId = tableId;
        }else if(table.classList.contains(classNames.booking.tableChosed)){
  ...
  sendBooking(){
    ...
    const payload = {
      ...
      table: parseInt(thisBooking.chosedTableId),
